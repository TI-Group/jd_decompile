...
public class FollowedMeAdapter extends Adapter<ViewHolder> {
    ...
    class a extends ViewHolder {
        final /* synthetic */ FollowedMeAdapter a;
        private final View b;
        private final CircularImageView c;
        private final TextView d;
        private final Button e;

        public a(FollowedMeAdapter followedMeAdapter, View view) {
            this.a = followedMeAdapter;
            super(view);
            this.b = view;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        aVar.e.setOnClickListener(new OnClickListener(this) {
            ...
            public void onClick(View view) {
                ...
                new com.jd.fridge.widget.b.a(this.a.a).a(this.a.a(friendInfo.getNickname(), R.string.activity_friends_list_remove_follower_toast, R.dimen.confirm_dialog_nickname_biger_textsize)).a(b.DOUBLE_BTN).b((int) R.string.activity_setting_no_btn).c((int) R.string.activity_setting_yes_btn).a(new com.jd.fridge.widget.b.a.a(this) {
