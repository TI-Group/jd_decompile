...
class b {
    ...
    private void b(com.sina.weibo.sdk.b.a r9) {
...
*/
    ...
    L_0x003a:
        r0 = r8.c;
        r0 = com.sina.weibo.sdk.d.f.b(r0);
    ...
    L_0x0048:
        r3 = "";
        r0 = r8.c;	 Catch:{ b -> 0x0091, all -> 0x00a2 }
        r4 = "GET";	 Catch:{ b -> 0x0091, all -> 0x00a2 }
        r5 = new com.sina.weibo.sdk.net.f;	 Catch:{ b -> 0x0091, all -> 0x00a2 }
        r6 = "";	 Catch:{ b -> 0x0091, all -> 0x00a2 }
        r5.<init>(r6);	 Catch:{ b -> 0x0091, all -> 0x00a2 }
        r0 = com.sina.weibo.sdk.net.c.a(r0, r2, r4, r5);	 Catch:{ b -> 0x0091, all -> 0x00a2 }
        r2 = a(r0);	 Catch:{ b -> 0x0091, all -> 0x00a2 }
        r4 = android.text.TextUtils.isEmpty(r2);	 Catch:{ b -> 0x0091, all -> 0x00a2 }
        if (r4 != 0) goto L_0x006b;	 Catch:{ b -> 0x0091, all -> 0x00a2 }
    L_0x0063:
        r4 = ".apk";	 Catch:{ b -> 0x0091, all -> 0x00a2 }
        r4 = r2.endsWith(r4);	 Catch:{ b -> 0x0091, all -> 0x00a2 }
        if (r4 != 0) goto L_0x007e;	 Catch:{ b -> 0x0091, all -> 0x00a2 }
    L_0x006b:
        r0 = b;	 Catch:{ b -> 0x0091, all -> 0x00a2 }
        r1 = "redirectDownloadUrl is illeagle";	 Catch:{ b -> 0x0091, all -> 0x00a2 }
        com.sina.weibo.sdk.d.d.c(r0, r1);	 Catch:{ b -> 0x0091, all -> 0x00a2 }
    ...
    L_0x0078:
        ...
        goto L_0x0008;
    L_0x007e:
        r4 = r8.c;	 Catch:{ b -> 0x0091, all -> 0x00a2 }
        r0 = com.sina.weibo.sdk.net.c.a(r4, r0, r1, r2);	 Catch:{ b -> 0x0091, all -> 0x00a2 }
    ...
    L_0x0091:
        r0 = move-exception;
        r0.printStackTrace();	 Catch:{ b -> 0x0091, all -> 0x00a2 }
        r0 = android.text.TextUtils.isEmpty(r3);
        if (r0 != 0) goto L_0x0008;
    L_0x009b:
        r0 = r8.c;
    ...
    L_0x00ae:
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sina.weibo.sdk.b.b.b(com.sina.weibo.sdk.b.a):void");
    }
    ...
    private static void a(Context context, a aVar, String str) {
        com.sina.weibo.sdk.d.h.a.a().c(aVar.e()).a(b(context, str)).b(c(context, aVar.f())).a(aVar.e()).a(context).a(1);
    }
