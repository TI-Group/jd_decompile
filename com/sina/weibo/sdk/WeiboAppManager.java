    ...
    public WeiboInfo parseWeiboInfoByAsset(String str) {
        ...
        try {
            ...
            try {
                ...
                d.c(TAG, e6222.getMessage());
                return null;
            }
        } catch (JSONException e13) {
            e3 = e13;
            open = null;
            d.c(TAG, e3.getMessage());
            if (open == null) {
                return null;
            }
            try {
                ...
                d.c(TAG, e62222.getMessage());
                return null;
            }
        } catch (Exception e14) {
            e4 = e14;
            open = null;
            d.c(TAG, e4.getMessage());
            if (open == null) {
                return null;
            }
            try {
