            ...
            try {
                ...
                for (NeighboringCellInfo neighboringCellInfo : list) {
                    ...
                    if (a(bVar.a, i2, i3, parseInt, neighboringCellInfo.getCid())) {
                        ...
                        stringBuilder.append(a(i2, i3, parseInt, neighboringCellInfo.getCid(), (neighboringCellInfo.getRssi() << 1) - 113, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED));
                        parseInt = i + 1;
                    } else {
                        parseInt = i;
                    }
