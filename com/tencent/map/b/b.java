...
public class b {
    private static b b;
    public String a = "";
    private double c = JDMaInterface.PV_UPPERLIMIT;
    private double d = JDMaInterface.PV_UPPERLIMIT;
    private double e = JDMaInterface.PV_UPPERLIMIT;
    private double f = JDMaInterface.PV_UPPERLIMIT;
    private double g = JDMaInterface.PV_UPPERLIMIT;
    ...
    public final void a(double d, double d2, a aVar) {
        this.i = aVar;
        if (!(this.g == JDMaInterface.PV_UPPERLIMIT || this.h == JDMaInterface.PV_UPPERLIMIT)) {
