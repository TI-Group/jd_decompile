...
public class QQShare extends BaseApi {
    ...
    public void shareToQQ(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        if (Util.hasSDCard() || SystemUtils.compareQQVersion(activity, SystemUtils.QQ_VERSION_NAME_4_5_0) >= 0) {
            ...
            if (i != 5) {
                if (TextUtils.isEmpty(string4) || !(string4.startsWith("http://") || string4.startsWith(CommonUtil.URL_HEADER))) {
            ...
            if (TextUtils.isEmpty(string) || string.startsWith("http://") || string.startsWith(CommonUtil.URL_HEADER) || new File(string).exists()) {
