...
public class AuthAgent extends BaseApi {
    ...
    private class FeedConfirmListener implements IUiListener {
        ...
        private View a(Context context, Drawable drawable, String str, OnClickListener onClickListener, OnClickListener onClickListener2) {
            ...
            imageView.setBackgroundColor(Color.rgb(ErrorCode.COPY_TMPDIR_ERROR, ErrorCode.COPY_TMPDIR_ERROR, ErrorCode.COPY_TMPDIR_ERROR));
            imageView.setId(3);
    ...
    private class TokenListener implements IUiListener {
        ...
        public void onComplete(Object obj) {
            ...
            try {
                ...
                if (string != null) {
                    try {
                        this.d.getSharedPreferences(Constants.PREFERENCE_PF, 0).edit().putString("pf", string).commit();
                    } catch (Throwable e) {
                        e.printStackTrace();
