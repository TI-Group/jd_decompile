...
public class AuthDialog extends Dialog {
            ...
            if (str.startsWith(AuthConstants.REDIRECT_BROWSER_URI)) {
                ...
                if (!this.a.m) {
                    if (parseUrlToJson.optString("fail_cb", null) != null) {
                        ...
                        AuthDialog.a(this.a, this.a.a.indexOf(HttpUtils.URL_AND_PARA_SEPARATOR) > -1 ? HttpUtils.PARAMETERS_SEPARATOR : HttpUtils.URL_AND_PARA_SEPARATOR);
    ...
    static {
        try {
            ...
            } else if (new File(context.getFilesDir().toString() + HttpUtils.PATHS_SEPARATOR + AuthAgent.SECURE_LIB_NAME).exists()) {
                System.load(context.getFilesDir().toString() + HttpUtils.PATHS_SEPARATOR + AuthAgent.SECURE_LIB_NAME);
    ...
    private String a() {
        String str = ServerSetting.DOWNLOAD_QQ_URL + this.a.substring(this.a.indexOf(HttpUtils.URL_AND_PARA_SEPARATOR) + 1);
    ...
    private boolean e() {
        ...
        this.a = substring + HttpUtils.URL_AND_PARA_SEPARATOR + Util.encodeUrl(parseUrl);
