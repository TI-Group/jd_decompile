...
public class GameAppOperation extends BaseApi {
    ...
    public void bindQQGroup(Activity activity, Bundle bundle) {
        ...
        if (activity == null) {
            ...
            stringBuffer.append(HttpUtils.PARAMETERS_SEPARATOR + Util.encodeUrl(composeActivityParams));
        ...
        if (a(activity, bundle, iUiListener)) {
            ...
            if (stringArrayList != null) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    try {
                        stringBuffer2.append(URLEncoder.encode(((String) stringArrayList.get(i2)).trim(), HTTP.UTF_8));
                    } catch (Throwable e) {
                        e.printStackTrace();
                    ...
                    if (stringArrayList != null && stringArrayList.size() > 0) {
                        ...
                        while (i < size) {
                            ...
                            if (!str3.startsWith(HttpUtils.PATHS_SEPARATOR)) {
                                ...
                                return;
                            } else if (!str3.startsWith(HttpUtils.PATHS_SEPARATOR) || new File(str3).exists()) {
                                i++;
                            } else {
                        ...
                        for (i = 0; i < size; i++) {
                            try {
                                stringBuffer.append(URLEncoder.encode(((String) stringArrayList.get(i)).trim(), HTTP.UTF_8));
                            } catch (Throwable e) {
                                e.printStackTrace();
                                f.b("openSDK_LOG.GameAppOperation", "UnsupportedEncodingException: ", e);
    ...
    public void sharePrizeToQQ(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        if (iUiListener == null) {
            ...
            if (TextUtils.isEmpty(string3) || !(string3.startsWith("http://") || string3.startsWith(CommonUtil.URL_HEADER))) {
            ...
            ThreadManager.executeOnSubThread(new Runnable(this) {
                ...
                public void run() {
                    ...
                    try {
                        JSONObject request = com.tencent.open.utils.HttpUtils.request(this.e.mToken, activity2.getApplicationContext(), ServerSetting.URL_PRIZE_MAKE_SHARE_URL, a, "GET");
                        try {
        ...
        if (iUiListener == null) {
            ...
            ThreadManager.executeOnSubThread(new Runnable(this) {
                ...
                public void run() {
                    ...
                    a.putAll(bundle);
                    try {
                        iUiListener.onComplete(com.tencent.open.utils.HttpUtils.request(this.d.mToken, context, ServerSetting.URL_PRIZE_QUERY_UNEXCHANGE, a, "GET"));
                    } catch (Throwable e) {
        ...
        if (iUiListener == null) {
            ...
            ThreadManager.executeOnSubThread(new Runnable(this) {
                ...
                public void run() {
                    ...
                    try {
                        iUiListener.onComplete(com.tencent.open.utils.HttpUtils.request(this.d.mToken, context, ServerSetting.URL_PRIZE_EXCHANGE, a, "GET"));
                    } catch (Throwable e) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            ThreadManager.executeOnSubThread(new Runnable(this) {
                ...
                public void run() {
                    ...
                    try {
                        iUiListener.onComplete(com.tencent.open.utils.HttpUtils.request(this.d.mToken, activity.getApplicationContext(), ServerSetting.URL_PRIZE_GET_ACTIVITY_STATE, a, "GET"));
                    } catch (Throwable e) {
