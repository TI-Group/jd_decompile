...
public class AppbarAgent extends BaseApi {
    ...
    public void startAppbarLabel(Activity activity, String str) {
        ...
        this.a = new Bundle();
        this.a.putString(j.EXTRA_PARAMS, "label/" + str);
    ...
    private String a() {
        ...
        return HttpUtils.PARAMETERS_SEPARATOR + a(bundle);
    }
    ...
    private String a(Bundle bundle) {
        ...
        for (String str : bundle.keySet()) {
            stringBuilder.append(str).append(HttpUtils.EQUAL_SIGN).append(bundle.get(str)).append(HttpUtils.PARAMETERS_SEPARATOR);
        }
