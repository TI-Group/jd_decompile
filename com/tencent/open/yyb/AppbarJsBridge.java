            ...
            if (host.equals("callBatch")) {
                try {
                    ...
                    for (int i2 = 0; i2 < length; i2++) {
                        ...
                        stringBuilder.append(JS_BRIDGE_SCHEME).append(string).append(HttpUtils.PATHS_SEPARATOR).append(i3).append(HttpUtils.PATHS_SEPARATOR).append(!TextUtils.isEmpty(optString) ? optString : "").append(HttpUtils.URL_AND_PARA_SEPARATOR);
                        if (jSONObject2 != null) {
                            Iterator keys = jSONObject2.keys();
                            while (keys.hasNext()) {
                                String str3 = (String) keys.next();
                                stringBuilder.append(str3).append(HttpUtils.EQUAL_SIGN).append(Uri.encode(Uri.decode(jSONObject2.getString(str3)))).append(HttpUtils.PARAMETERS_SEPARATOR);
                            }
                        }
