...
public class Util {
        ...
        for (String str : bundle.keySet()) {
            ...
            if ((obj2 instanceof String) || (obj2 instanceof String[])) {
                ...
                if (obj2 instanceof String[]) {
                    ...
                    stringBuilder.append(URLEncoder.encode(str) + HttpUtils.EQUAL_SIGN);
                    ...
                    stringBuilder.append(URLEncoder.encode(str) + HttpUtils.EQUAL_SIGN + URLEncoder.encode(bundle.getString(str)));
                    obj3 = obj;
                }
                obj = obj3;
            }
    ...
    public static final boolean isValidUrl(String str) {
        ...
        if (str.startsWith("http://") || str.startsWith(CommonUtil.URL_HEADER)) {
            return true;
        }
        return false;
    }
