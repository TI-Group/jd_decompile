...
public class OpenConfig {
    ...
    private String a(String str) {
        ...
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(openFileInput, Charset.forName(HTTP.UTF_8)));
    ...
    private void c() {
        ...
        if (SystemClock.elapsedRealtime() - this.f >= ((long) (optInt * DateUtils.MILLIS_IN_HOUR))) {
            b();
        }
    }
