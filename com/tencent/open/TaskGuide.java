...
public class TaskGuide extends BaseApi {
    ...
    class c implements Runnable {
        ...
        public void run() {
            ...
            com.tencent.open.a.f.b("openSDK_LOG.TaskGuide", "mWinParams.y = " + this.c.d.y + "deltaDistence = " + interpolation);
            if (this.c.E) {
    ...
    private class i extends LinearLayout {
        ...
        private void a() {
            ...
            this.b.setShadowLayer(1.0f, 1.0f, 1.0f, Color.rgb(242, ErrorCode.EXCEED_COPY_RETRY_NUM, 199));
            this.b.setGravity(3);
            ...
            this.c.setShadowLayer(1.0f, 1.0f, 1.0f, Color.rgb(242, ErrorCode.EXCEED_COPY_RETRY_NUM, 199));
