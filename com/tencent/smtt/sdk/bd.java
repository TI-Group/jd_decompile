...
class bd {
    ...
    public bd(Context context, Context context2, String str, String str2, String[] strArr, String str3, an anVar) {
        ...
        this.f = str2;
        if (anVar != null) {
            anVar.a("load_tbs_dex", (byte) 1);
        }
        this.e = new DexLoader(str3, this.a, this.d, str2, QbSdk.k);
        if (anVar != null) {
            anVar.a("load_tbs_dex", (byte) 2);
        }
        ...
        if (anVar != null) {
            anVar.a("init_tbs", (byte) 1);
        }
        int a = a(context);
        if (anVar != null) {
            anVar.a("init_tbs", (byte) 2);
        }
        if (a < 0) {
    ...
    private void d() {
        this.e.setStaticField("com.tencent.tbs.tbsshell.TBSShell", "VERSION", Integer.valueOf(43200));
    }
