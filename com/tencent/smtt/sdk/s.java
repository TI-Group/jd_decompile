...
class s extends X5ProxyWebChromeClient {
    private WebView a;
    ...
    class a implements QuotaUpdater {
        ...
        a(s sVar, com.tencent.smtt.export.external.interfaces.QuotaUpdater quotaUpdater) {
            this.b = sVar;
            this.a = quotaUpdater;
        }
    ...
    public s(IX5WebChromeClient iX5WebChromeClient, WebView webView, WebChromeClient webChromeClient) {
    ...
    public boolean onCreateWindow(IX5WebViewBase iX5WebViewBase, boolean z, boolean z2, Message message) {
        ...
        Message obtain = Message.obtain(message.getTarget(), new t(this, webViewTransport, message));
    ...
    public boolean onShowFileChooser(IX5WebViewBase iX5WebViewBase, ValueCallback<Uri[]> valueCallback, FileChooserParams fileChooserParams) {
        ValueCallback vVar = new v(this, valueCallback);
        WebChromeClient.FileChooserParams wVar = new w(this, fileChooserParams);
        this.a.a(iX5WebViewBase);
        return this.b.onShowFileChooser(this.a, vVar, wVar);
    }

    public void openFileChooser(ValueCallback<Uri[]> valueCallback, String str, String str2, boolean z) {
        this.b.openFileChooser(new u(this, valueCallback), str, str2);
    }
}
