...
public class WebSettings {
    ...
    public ZoomDensity getDefaultZoom() {
        return (!this.c || this.a == null) ? (this.c || this.b == null) ? null : ZoomDensity.valueOf(this.b.getDefaultZoom().name()) : ZoomDensity.valueOf(this.a.getDefaultZoom().name());
    }
    ...
    public synchronized LayoutAlgorithm getLayoutAlgorithm() {
        ...
        valueOf = (!this.c || this.a == null) ? (this.c || this.b == null) ? null : LayoutAlgorithm.valueOf(this.b.getLayoutAlgorithm().name()) : LayoutAlgorithm.valueOf(this.a.getLayoutAlgorithm().name());
        return valueOf;
    }
    ...
    public TextSize getTextSize() {
        return (!this.c || this.a == null) ? (this.c || this.b == null) ? null : TextSize.valueOf(this.b.getTextSize().name()) : TextSize.valueOf(this.a.getTextSize().name());
    }
    ...
    public synchronized void setPluginState(PluginState pluginState) {
        if (this.c && this.a != null) {
            ...
            v.a(this.b, "setPluginState", new Class[]{android.webkit.WebSettings.PluginState.class}, valueOf);
        }
    }
