...
public class a {
    public static final byte[] a = new byte[]{(byte) 98, (byte) -24, ReplyCode.reply0x39, (byte) -84, ReplyCode.reply0x8d, (byte) 117, ReplyCode.reply0x37, (byte) 121};
    public static final byte[] b = new byte[]{(byte) -25, (byte) -101, ReplyCode.reply0x8d, (byte) 1, (byte) 47, (byte) 7, (byte) -27, (byte) -59, ReplyCode.reply0x12, Byte.MIN_VALUE, ReplyCode.reply0x7b, ReplyCode.reply0x4f, (byte) -44, ReplyCode.reply0x25, (byte) 46, (byte) 115};
    public static final byte[] c = new byte[]{ReplyCode.reply0x25, (byte) -110, (byte) 60, Byte.MAX_VALUE, (byte) 42, (byte) -27, (byte) -17, (byte) -110};
    public static final byte[] d = new byte[]{ReplyCode.reply0x86, (byte) -8, (byte) -23, (byte) -84, ReplyCode.reply0x83, (byte) 113, (byte) 84, (byte) 99};
    ...
    private static void a(int[] iArr, int i, int i2, int[][] iArr2) {
        ...
        for (i3 = 0; i3 < 48; i3++) {
            iArr7[i3] = iArr4[j[i3] - 1];
            iArr7[i3] = iArr7[i3] + iArr2[i][i3];
            if (iArr7[i3] == 2) {
                iArr7[i3] = 0;
            }
        }
        for (int i4 = 0; i4 < 8; i4++) {
            for (i3 = 0; i3 < 6; i3++) {
                iArr8[i4][i3] = iArr7[(i4 * 6) + i3];
            }
            iArr9[i4] = l[i4][(iArr8[i4][0] << 1) + iArr8[i4][5]][(((iArr8[i4][1] << 3) + (iArr8[i4][2] << 2)) + (iArr8[i4][3] << 1)) + iArr8[i4][4]];
            for (i3 = 0; i3 < 4; i3++) {
                iArr10[((i4 * 4) + 3) - i3] = iArr9[i4] % 2;
                iArr9[i4] = iArr9[i4] / 2;
            }
        }
        for (int i5 = 0; i5 < 32; i5++) {
            iArr11[i5] = iArr10[k[i5] - 1];
            iArr5[i5] = iArr4[i5];
            iArr6[i5] = iArr3[i5] + iArr11[i5];
            if (iArr6[i5] == 2) {
                iArr6[i5] = 0;
            }
    ...
    public static byte[] a(byte[] bArr, byte[] bArr2, int i) {
        ...
        try {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                System.arraycopy(c, 0, obj3, 0, 8);
                System.arraycopy(b, i3 * 8, obj4, 0, 8);
                System.arraycopy(b(obj3, obj4, i), 0, obj2, i3 * 8, 8);
            }
            if (i == 0) {
                b = new byte[bArr2.length];
                System.arraycopy(obj2, 0, b, 0, b.length);
                byte b2 = b[b.length - 1];
                if (b2 > (byte) 0 && b2 <= (byte) 8) {
                    for (byte b3 = (byte) 0; b3 < b2; b3++) {
                        if (b2 != b[(b.length - 1) - b3]) {
                            break;
                        }
                    }
                    int i4 = 1;
                    if (obj != null) {
                        obj2 = new byte[(b.length - b2)];
                        System.arraycopy(b, 0, obj2, 0, obj2.length);
                    }
                }
            }
            return obj2;
    ...
    private static byte[] a(int[] iArr, int i, int[][] iArr2) {
        int i2;
        int i3 = 0;
    ...
    private static byte[] b(byte[] bArr, byte[] bArr2, int i) {
        if (bArr.length == 8 && bArr2.length == 8 && (i == 1 || i == 0)) {
            ...
            int[][] iArr2 = (int[][]) Array.newInstance(Integer.TYPE, new int[]{16, 48});
            int[] a = a(bArr);
            int[] a2 = a(bArr2);
            a(a, iArr2);
            return a(a2, i, iArr2);
