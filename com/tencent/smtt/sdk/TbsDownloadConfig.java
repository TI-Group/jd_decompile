...
public class TbsDownloadConfig {
    ...
    public synchronized int getDownloadInterruptCode() {
        ...
        if (this.mPreferences.contains(TbsConfigKey.KEY_DOWNLOAD_INTERRUPT_CODE)) {
            ...
            try {
                i = !new File(new File(this.c.getFilesDir(), "shared_prefs"), "tbs_download_config").exists() ? -97 : !this.mPreferences.contains(TbsConfigKey.KEY_NEEDDOWNLOAD) ? -96 : Config.ERR_CODE_REQUEST_FAILED_OR_TIMEOUT;
            } catch (Throwable th) {
                i = -95;
            }
        }
