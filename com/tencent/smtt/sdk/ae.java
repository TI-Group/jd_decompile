...
class ae extends WebViewClient {
    ...
    private class e implements WebResourceRequest {
        ...
        public e(ae aeVar, String str, boolean z, boolean z2, String str2, Map<String, String> map) {
            this.a = aeVar;
            this.b = str;
            this.c = z;
            this.d = z2;
    ...
    ae(WebView webView, WebViewClient webViewClient) {
        this.b = webView;
    ...
    public void onReceivedError(WebView webView, android.webkit.WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        ...
        if (webResourceError != null) {
            webResourceError2 = new ag(this, webResourceError);
        }
    ...
    public boolean shouldOverrideUrlLoading(WebView webView, String str) {
        ...
        this.b.a(webView);
        return !s.a().a(this.b.getContext().getApplicationContext(), str) ? this.a.shouldOverrideUrlLoading(this.b, str) : true;
    }
}
