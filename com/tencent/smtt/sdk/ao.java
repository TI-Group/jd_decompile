...
class ao {
    public static ThreadLocal<Integer> a = new ap();
    ...
    private ao() {
        if (k == null) {
            k = new aq(this, am.a().getLooper());
        }
    }

    static synchronized ao a() {
        ao aoVar;
    ...
    L_0x0076:
        r0 = h;
        r0.lock();
        r0 = com.tencent.smtt.sdk.aj.a(r14);	 Catch:{ Exception -> 0x02aa }
        r1 = "copy_core_ver";
    ...
    L_0x00ab:
        ...
        goto L_0x0011;
    L_0x00b0:
        r2 = r12.e(r14);	 Catch:{ Exception -> 0x02aa }
        r3 = "TbsInstaller";
    ...
    L_0x00ce:
        ...
        goto L_0x00ab;
    L_0x00e9:
        r3 = com.tencent.smtt.sdk.aj.a(r14);	 Catch:{ Exception -> 0x02aa }
    ...
    L_0x00f9:
        r12.i(r14);	 Catch:{ Exception -> 0x02aa }
    L_0x00fc:
        r1 = 3;
    ...
    L_0x017f:
        ...
        goto L_0x00ab;
    L_0x019f:
        r1 = com.tencent.smtt.sdk.aj.a(r14);	 Catch:{ Exception -> 0x02aa }
        r2 = "copy_retry_num";
        r0 = r0 + 1;
        r1.a(r2, r0);	 Catch:{ Exception -> 0x02aa }
    L_0x01aa:
        r0 = r12.k(r13);	 Catch:{ Exception -> 0x02aa }
        r6 = r12.o(r14);	 Catch:{ Exception -> 0x02aa }
    ...
    L_0x0385:
        ...
        r1 = com.tencent.smtt.sdk.ah.b(r13);	 Catch:{ Exception -> 0x02aa }
    ...
    L_0x03a6:
        ...
        com.tencent.smtt.sdk.ah.a(r2, r14);	 Catch:{ Exception -> 0x02aa }
    L_0x03ac:
        r0 = com.tencent.smtt.sdk.aj.a(r14);	 Catch:{ Exception -> 0x02aa }
        r1 = 1;
    ...
    L_0x04cb:
        ...
        goto L_0x0299;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.smtt.sdk.ao.a(android.content.Context, android.content.Context, int):void");
    }
    ...
    private boolean a(Context context, File file, boolean z) {
        ...
        if (k.c(file)) {
            ...
            try {
                k.a(dir);
                boolean a = k.a(file, dir);
                if (a) {
                    f(context, true);
                } else {
                    k.b(dir);
                    TbsDownloadConfig.getInstance(context).setInstallInterruptCode(-522);
                    TbsLog.e("TbsInstaller", "copyFileIfChanged -- delete tmpTbsCoreUnzipDir#1! exist:" + dir.exists());
                }
                ...
                if (z2 && dir != null) {
                    k.b(dir);
                    TbsLog.e("TbsInstaller", "copyFileIfChanged -- delete tmpTbsCoreUnzipDir#2! exist:" + dir.exists());
                }
    ...
    private void b(Context context, String str, int i) {
        ...
        if ((VERSION.SDK_INT >= 11 ? context.getSharedPreferences("tbs_preloadx5_check_cfg_file", 4) : context.getSharedPreferences("tbs_preloadx5_check_cfg_file", 0)).getInt("tbs_precheck_disable_version", -1) == i) {
            ...
            TbsLogReport.a(context).a((int) ErrorCode.ROM_NOT_ENOUGH, "rom is not enough when installing tbs core! curAvailROM=" + a + ",minReqRom=" + downloadMinFreeSpace);
        } else if (p(context)) {
            ...
            if (tryLock) {
                ...
                h.lock();
                int c = aj.a(context).c("copy_core_ver");
                ...
                if (i4 < 1) {
                    ...
                    if (z) {
                        c = aj.a(context).c("unzip_retry_num");
                        if (c > 10) {
                    ...
                    if (str == null) {
                        d = aj.a(context).d("install_apk_path");
                        if (d == null) {
                    ...
                    try {
                        ...
                        aj.a(context).a("install_apk_path", d);
                        aj.a(context).b(b2, 0);
                        ...
                        if (z) {
                            c = aj.a(context).b("unlzma_status");
                            if (c > 5) {
                                TbsLogReport.a(context).a((int) ErrorCode.EXCEED_LZMA_RETRY_NUM, "exceed unlzma retry num!");
                        ...
                        if (e(context) != 0) {
                            ...
                            if (tryLock) {
                                ...
                                bundle.putString("unzip_temp_path", n(context).getAbsolutePath());
                                a2 = QbSdk.a(context, "unlzma", bundle);
                                if (a2 == null) {
                                    TbsLog.i("TbsInstaller", "unlzma return null");
                                    TbsLogReport.a(context).a((int) ErrorCode.UNLZMA_FAIURE, "unlzma is null");
                                    ...
                                    if (((Boolean) a2).booleanValue()) {
                                        ...
                                        TbsLogReport.a(context).a((int) ErrorCode.UNLZMA_FAIURE, "unlzma return false");
                                        tryLock = false;
                                    }
                                    boolean z2 = tryLock;
                                    ...
                                    TbsLogReport.a(context).a((int) ErrorCode.UNLZMA_FAIURE, (Throwable) a2);
                                }
                                if (i3 == 0) {
                                    h.unlock();
                                    i.unlock();
                ...
                if (i4 < 2) {
                    if (z) {
                        c = aj.a(context).c("dexopt_retry_num");
                        if (c > 10) {
                            TbsLogReport.a(context).a((int) ErrorCode.EXCEED_DEXOPT_RETRY_NUM, "exceed dexopt retry num!");
                    ...
                    if (c(context, 0)) {
                        ...
                        if (this.j) {
                            ...
                            if (aj.a(context).d() == 1) {
                                i2 = ErrorCode.INCRUPDATE_INSTALL_SUCCESS;
                            }
                            a3.a(i2, "continueInstallWithout core success");
                        } else {
                            TbsLogReport.a(context).a(aj.a(context).d() == 1 ? ErrorCode.INCRUPDATE_INSTALL_SUCCESS : 200, "success");
                        }
                    } else {
    ...
    private boolean b(Context context, File file) {
        try {
            ...
            e2.printStackTrace();
            TbsLogReport.a(context).a((int) ErrorCode.DEXOPT_EXCEPTION, e2.toString());
    ...
    L_0x0036:
        return r2;
    L_0x0037:
        r0 = r8.n(r9);	 Catch:{ Exception -> 0x008f }
    L_0x003b:
        r1 = "java.vm.version";
    ...
    L_0x0070:
        ...
        goto L_0x0036;
    L_0x0075:
        r0 = r8.o(r9);	 Catch:{ Exception -> 0x008f }
        goto L_0x003b;
    L_0x007a:
    ...
    L_0x008f:
        ...
        goto L_0x0036;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.smtt.sdk.ao.c(android.content.Context, int):boolean");
    }
    ...
    private boolean c(Context context, File file) {
        try {
            ...
            Object a = d.a(context, file3.getAbsolutePath());
            if (TextUtils.isEmpty(a)) {
                TbsLogReport.a(context).a((int) ErrorCode.DEXOAT_EXCEPTION, "can not find oat command");
                return false;
            }
            for (File file4 : file.listFiles(new av(this))) {
                String substring = file4.getName().substring(0, file4.getName().length() - 4);
                Runtime.getRuntime().exec("/system/bin/dex2oat " + a.replaceAll("tbs_sdk_extension_dex", substring) + " --dex-location=" + a().k(context) + File.separator + substring + ".jar").waitFor();
            }
            return true;
        } catch (Throwable e) {
            e.printStackTrace();
            TbsLogReport.a(context).a((int) ErrorCode.DEXOAT_EXCEPTION, e);
            return false;
        }
    }
        ...
        synchronized (this) {
            ...
            try {
                if (p(context)) {
                    ...
                    if (tryLock) {
                        int b = aj.a(context).b("copy_status");
                        ...
                        try {
                            ...
                            z2 = z3;
                            th = th3;
                            TbsLogReport.a(context).a((int) ErrorCode.COPY_EXCEPTION, th.toString());
        ...
        while (i2 < coreProviderAppList.length) {
            if (!context.getPackageName().equalsIgnoreCase(coreProviderAppList[i2]) && d(context, coreProviderAppList[i2])) {
                ...
                if (a == null) {
                    ...
                    int e = e(a);
                    TbsLog.i("TbsInstaller", "TbsInstaller-getTbsCoreHostContext hostTbsCoreVer=" + e);
                    if (e != 0 && e == i) {
    ...
    private void f(Context context, boolean z) {
        if (context == null) {
            TbsLogReport.a(context).a((int) ErrorCode.CREATE_TEMP_CONF_ERROR, "setTmpFolderCoreToRead context is null");
            return;
        }
        try {
            ...
            TbsLogReport.a(context).a((int) ErrorCode.CREATE_TEMP_CONF_ERROR, "setTmpFolderCoreToRead Exception message is " + e.getMessage() + " Exception cause is " + e.getCause());
        }
    }
    ...
    private void r(Context context) {
        ...
        if (bo.b().a() == null && bo.b().a(context) == null) {
        ...
        try {
            ...
            aj.a(context).b(0);
            aj.a(context).d(0);
            aj.a(context).a("incrupdate_retry_num", 0);
            aj.a(context).b(0, 3);
            aj.a(context).a("");
            aj.a(context).c(-1);
            if (!TbsShareManager.isThirdPartyApp(context)) {
                int i = TbsDownloadConfig.getInstance(context).mPreferences.getInt(TbsConfigKey.KEY_DECOUPLECOREVERSION, 0);
                if (i > 0 && i != a().d(context) && i == a().e(context)) {
                    h(context);
                }
            }
            if (TbsShareManager.isThirdPartyApp(context)) {
                TbsShareManager.writeCoreInfoForThirdPartyApp(context, g(context), true);
            }
            a.set(Integer.valueOf(0));
        } catch (Throwable th) {
            th.printStackTrace();
            TbsLogReport.a(context).a((int) ErrorCode.RENAME_EXCEPTION, "exception when renameing from unzip:" + th.toString());
    ...
    private void s(Context context) {
        ...
        try {
            ...
            e.printStackTrace();
            TbsLogReport.a(context).a((int) ErrorCode.RENAME_EXCEPTION, "exception when renameing from copy:" + e.toString());
        }
    }
    ...
    public int a(boolean z, Context context) {
        if (z || ((Integer) a.get()).intValue() <= 0) {
            a.set(Integer.valueOf(e(context)));
        }
        ...
        if (p(context)) {
            ...
            if (tryLock != 0) {
                try {
                    c = aj.a(context).c();
                    b = aj.a(context).b();
                    name = aj.a(context).d("install_apk_path");
                    c2 = aj.a(context).c("copy_core_ver");
                    tryLock = aj.a(context).b("copy_status");
                } finally {
                    z2 = h;
                    z2.unlock();
                }
    ...
    L_0x0094:
        r1 = 0;
        r0 = 1;
        com.tencent.smtt.sdk.QbSdk.setTBSInstallingStatus(r0);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r0 = r10.e(r11);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        if (r0 <= 0) goto L_0x00a9;
    L_0x009f:
        r0 = com.tencent.smtt.sdk.aj.a(r11);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r0 = r0.d();	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
    ...
    L_0x00bc:
        ...
        goto L_0x0016;
    L_0x00c1:
        r0 = com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r11);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r0 = r0.mPreferences;	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r4 = "tbs_responsecode";
        r6 = 0;
        r4 = r0.getInt(r4, r6);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
    ...
    L_0x00da:
        ...
        r0 = r0.c(r4);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r4 = 5;
        if (r0 <= r4) goto L_0x0160;
    L_0x00e7:
        r0 = "TbsInstaller";
        r4 = "TbsInstaller-installLocalTesCoreExInThread exceed incrupdate num";
        com.tencent.smtt.utils.TbsLog.i(r0, r4);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r0 = "old_apk_location";
        r0 = r12.getString(r0);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r4 = "new_apk_location";
        r4 = r12.getString(r4);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r6 = "diff_file_location";
        r6 = r12.getString(r6);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r7 = android.text.TextUtils.isEmpty(r0);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        if (r7 != 0) goto L_0x010e;
    L_0x0106:
        r7 = new java.io.File;	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r7.<init>(r0);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        com.tencent.smtt.utils.k.b(r7);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
    L_0x010e:
        r0 = android.text.TextUtils.isEmpty(r4);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        if (r0 != 0) goto L_0x011c;
    L_0x0114:
        r0 = new java.io.File;	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r0.<init>(r4);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        com.tencent.smtt.utils.k.b(r0);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
    L_0x011c:
        r0 = android.text.TextUtils.isEmpty(r6);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        if (r0 != 0) goto L_0x012a;
    L_0x0122:
        r0 = new java.io.File;	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r0.<init>(r6);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        com.tencent.smtt.utils.k.b(r0);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
    L_0x012a:
        r0 = com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r11);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r0 = r0.a;	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r4 = "tbs_needdownload";
        r6 = 1;
        r6 = java.lang.Boolean.valueOf(r6);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r0.put(r4, r6);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r0 = com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r11);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r0.commit();	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r0 = com.tencent.smtt.sdk.TbsLogReport.a(r11);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r4 = 224; // 0xe0 float:3.14E-43 double:1.107E-321;
        r6 = "incrUpdate exceed retry max num";
        r0.a(r4, r6);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r0 = i;
        r0.unlock();
        r10.b();
        r0 = "TbsInstaller";
    ...
    L_0x015d:
        ...
        goto L_0x00d6;
    L_0x0160:
        r4 = com.tencent.smtt.sdk.aj.a(r11);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r6 = "incrupdate_retry_num";
        r0 = r0 + 1;
        r4.a(r6, r0);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r0 = m(r11);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        if (r0 == 0) goto L_0x035c;
    L_0x0171:
        r4 = new java.io.File;	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r6 = "x5.tbs";
        r4.<init>(r0, r6);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        if (r4 == 0) goto L_0x035c;
    L_0x017a:
        r0 = r4.exists();	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        if (r0 == 0) goto L_0x035c;
    L_0x0180:
        r0 = com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r11);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r4 = -550; // 0xfffffffffffffdda float:NaN double:NaN;
        r0.setInstallInterruptCode(r4);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
        r1 = com.tencent.smtt.sdk.QbSdk.a(r11, r12);	 Catch:{ Exception -> 0x01e2, all -> 0x0260 }
    ...
    L_0x019a:
        ...
        r0 = com.tencent.smtt.sdk.aj.a(r11);
        ...
        r2 = new java.io.File;
        r2.<init>(r0);
        com.tencent.smtt.sdk.ah.a(r2, r11);
        r2 = "tbs_core_ver";
        r1 = r1.getInt(r2);
        r10.a(r11, r0, r1);
        goto L_0x00bc;
    L_0x01db:
        r0 = "patch_result";
        r0 = r1.getInt(r0);	 Catch:{ Exception -> 0x01e2 }
        goto L_0x0190;
    L_0x01e2:
        r0 = move-exception;
        r4 = "TbsInstaller";
        r6 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0352 }
        r6.<init>();	 Catch:{ all -> 0x0352 }
        r7 = "installLocalTbsCoreExInThread exception:";
        r6 = r6.append(r7);	 Catch:{ all -> 0x0352 }
        r7 = android.util.Log.getStackTraceString(r0);	 Catch:{ all -> 0x0352 }
        r6 = r6.append(r7);	 Catch:{ all -> 0x0352 }
        r6 = r6.toString();	 Catch:{ all -> 0x0352 }
        com.tencent.smtt.utils.TbsLog.i(r4, r6);	 Catch:{ all -> 0x0352 }
        r0.printStackTrace();	 Catch:{ all -> 0x0352 }
        r4 = com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r11);	 Catch:{ all -> 0x0357 }
        r6 = -543; // 0xfffffffffffffde1 float:NaN double:NaN;
        r4.setInstallInterruptCode(r6);	 Catch:{ all -> 0x0357 }
        r4 = com.tencent.smtt.sdk.TbsLogReport.a(r11);	 Catch:{ all -> 0x0357 }
        r6 = 218; // 0xda float:3.05E-43 double:1.077E-321;
        r0 = r0.toString();	 Catch:{ all -> 0x0357 }
        r4.a(r6, r0);	 Catch:{ all -> 0x0357 }
        r0 = i;
        r0.unlock();
        r10.b();
        r0 = com.tencent.smtt.sdk.TbsDownloadConfig.getInstance(r11);
    ...
    L_0x026d:
        ...
        r1 = com.tencent.smtt.sdk.aj.a(r11);
        r2 = "incrupdate_retry_num";
        r1.a(r2, r5);
    ...
    L_0x035c:
        ...
        goto L_0x0190;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.smtt.sdk.ao.b(android.content.Context, android.os.Bundle):void");
    }
    ...
    L_0x0017:
        ...
        r6 = "false";
        r0 = r0.getProperty(r4, r6);	 Catch:{ Throwable -> 0x00a6, all -> 0x00a1 }
        r0 = java.lang.Boolean.valueOf(r0);	 Catch:{ Throwable -> 0x00a6, all -> 0x00a1 }
        r4 = r0.booleanValue();	 Catch:{ Throwable -> 0x00a6, all -> 0x00a1 }
        if (r4 == 0) goto L_0x00b0;
    L_0x003c:
        r6 = java.lang.System.currentTimeMillis();	 Catch:{ Throwable -> 0x00ab, all -> 0x00a1 }
        r8 = r5.lastModified();	 Catch:{ Throwable -> 0x00ab, all -> 0x00a1 }
        r6 = r6 - r8;
    ...
    L_0x00b0:
        ...
        goto L_0x004d;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.smtt.sdk.ao.b(android.content.Context):boolean");
    }
    ...
    int d(Context context) {
        ...
        BufferedInputStream bufferedInputStream2;
        try {
            File file = new File(j(context), "tbs.conf");
            if (file == null || !file.exists()) {
                if (bufferedInputStream != null) {
                    try {
                        bufferedInputStream.close();
    ...
    int e(Context context) {
        ...
        BufferedInputStream bufferedInputStream2;
        try {
            File file = new File(k(context), "tbs.conf");
            if (file == null || !file.exists()) {
                if (bufferedInputStream != null) {
                    try {
                        bufferedInputStream.close();
    ...
    void i(Context context) {
        ...
        aj.a(context).b(0, -1);
        aj.a(context).a("");
        aj.a(context).a("copy_retry_num", 0);
        aj.a(context).a(0, -1);
        aj.a(context).c(-1);
        k.a(n(context), true);
        k.a(o(context), true);
    ...
    synchronized boolean p(Context context) {
        boolean z = true;
        synchronized (this) {
            this.d++;
            if (this.g) {
