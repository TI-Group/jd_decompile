...
public class StatServiceImpl {
    ...
    static boolean b(Context context) {
        ...
        boolean z2 = true;
        if (b <= a) {
            q.error("MTA is disable for current version:" + b + ",wakeup version:" + a);
            z2 = false;
        }
        a = q.a(context, StatConfig.d, 0);
        if (a > System.currentTimeMillis()) {
            q.error("MTA is disable for current time:" + System.currentTimeMillis() + ",wakeup time:" + a);
        } else {
            z = z2;
        }
    ...
    static void d(Context context) {
        if (StatConfig.isEnableStatService()) {
            ...
            try {
                i.b(context2).a(new h(context2), new t());
            } catch (Throwable th) {
                q.e(th);
            }
        }
    ...
    static void e(Context context) {
        c = System.currentTimeMillis() + ((long) (DateUtils.MILLIS_IN_MINUTE * StatConfig.getSendPeriodMinutes()));
        ...
        try {
            if (StatConfig.isEnableStatService()) {
                ...
                if (context == null || str2 == null) {
                    ...
                    q.error(("MTA SDK version conflicted, current: " + str3 + ",required: " + str2) + ". please delete the current SDK and download the latest one. official website: http://mta.qq.com/ or http://mta.oa.com/");
                    StatConfig.setEnableStatService(false);
                    return false;
                } else {
