...
public final class Code39Reader extends OneDReader {
    ...
    static final int[] CHARACTER_ENCODINGS = new int[]{52, 289, 97, 352, 49, 304, 112, 37, 292, 100, 265, 73, ErrorCode.THROWABLE_INITTESRUNTIMEENVIRONMENT, 25, 280, 88, 13, 268, 76, 28, 259, 67, 322, 19, 274, 82, 7, 262, 70, 22, 385, 193, 448, 145, 400, ErrorCode.EXCEED_DEXOPT_RETRY_NUM, 133, 388, 196, 148, 168, 162, 138, 42};
    ...
    private static int[] findAsteriskPattern(BitArray bitArray, int[] iArr) throws NotFoundException {
        ...
        while (i < size) {
            if ((bitArray.get(i) ^ i2) != 0) {
                ...
                if (i3 != length - 1) {
                    i3++;
                } else if (toNarrowWidePattern(iArr) == ASTERISK_ENCODING && bitArray.isRange(Math.max(0, nextSet - ((i - nextSet) / 2)), nextSet, false)) {
                    return new int[]{nextSet, i};
                } else {
    ...
    private static String decodeExtended(CharSequence charSequence) throws FormatException {
        ...
        while (i < length) {
            ...
            if (charAt == '+' || charAt == ClassUtils.INNER_CLASS_SEPARATOR_CHAR || charAt == '%' || charAt == '/') {
