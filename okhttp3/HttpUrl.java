    ...
    public static final class Builder {
        ...
        private static int schemeDelimiterOffset(String str, int i, int i2) {
            ...
            while (i3 < i2) {
                ...
                if ((charAt2 >= 'a' && charAt2 <= 'z') || ((charAt2 >= 'A' && charAt2 <= 'Z') || ((charAt2 >= '0' && charAt2 <= '9') || charAt2 == '+' || charAt2 == '-' || charAt2 == ClassUtils.PACKAGE_SEPARATOR_CHAR))) {
                    i3++;
                } else if (charAt2 == ':') {
                    return i3;
                } else {
        ...
        private static boolean decodeIpv4Suffix(String str, int i, int i2, byte[] bArr, int i3) {
            ...
            while (i4 < i2) {
                ...
                if (i5 != i3) {
                    if (str.charAt(i4) != ClassUtils.PACKAGE_SEPARATOR_CHAR) {
                        return false;
                    }
                    i4++;
                }
            ...
            if (!(z && (codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13))) {
                if (codePointAt == 43 && z3) {
                    ...
                    while (!cVar2.e()) {
                        int h = cVar2.h() & 255;
                        cVar.b(37);
                        cVar.b(HEX_DIGITS[(h >> 4) & 15]);
                        cVar.b(HEX_DIGITS[h & 15]);
                    }
                } else {
                    cVar.a(codePointAt);
                }
