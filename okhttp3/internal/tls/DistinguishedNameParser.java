...
final class DistinguishedNameParser {
    ...
    private String nextAT() {
        ...
        if (this.end - this.beg > 4 && this.chars[this.beg + 3] == ClassUtils.PACKAGE_SEPARATOR_CHAR && ((this.chars[this.beg] == 'O' || this.chars[this.beg] == 'o') && ((this.chars[this.beg + 1] == 'I' || this.chars[this.beg + 1] == 'i') && (this.chars[this.beg + 2] == 'D' || this.chars[this.beg + 2] == 'd')))) {
            this.beg += 4;
        }
    ...
    private char getUTF8() {
        ...
        int i2;
        if (i <= ErrorCode.EXCEED_LZMA_RETRY_NUM) {
            i2 = 1;
            i &= 31;
        } else if (i <= 239) {
            i2 = 2;
