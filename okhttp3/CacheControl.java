...
public final class CacheControl {
    ...
    public static final class Builder {
        ...
        public Builder maxAge(int i, TimeUnit timeUnit) {
            ...
            this.maxAgeSeconds = toSeconds > 2147483647L ? ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED : (int) toSeconds;
            return this;
        }
        ...
        public Builder maxStale(int i, TimeUnit timeUnit) {
            ...
            long toSeconds = timeUnit.toSeconds((long) i);
            this.maxStaleSeconds = toSeconds > 2147483647L ? ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED : (int) toSeconds;
            return this;
        }
        ...
        public Builder minFresh(int i, TimeUnit timeUnit) {
            ...
            long toSeconds = timeUnit.toSeconds((long) i);
            this.minFreshSeconds = toSeconds > 2147483647L ? ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED : (int) toSeconds;
            return this;
        }
        ...
        while (i5 < size) {
            ...
            while (i6 < value.length()) {
                ...
                if ("no-cache".equalsIgnoreCase(trim)) {
                    ...
                    i3 = HeaderParser.parseSeconds(str2, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
