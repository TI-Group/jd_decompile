...
*/
    ...
    L_0x0061:
        ...
        goto L_0x002f;
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.jiguang.b.a.e.<clinit>():void");
    }
    ...
    L_0x005d:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.jiguang.b.a.e.b(boolean):void");
    }
            ...
            synchronized (this.f) {
                if (this.c == null || !this.c.isOpen()) {
                    ...
                    if (this.c.getVersion() != this.i) {
                        throw new SQLiteException(new StringBuilder(z[2]).append(this.c.getVersion()).append(z[0]).append(this.i).append(z[1]).append(path).toString());
                    }
                    this.a = 0;
                    onOpen(this.c);
                }
