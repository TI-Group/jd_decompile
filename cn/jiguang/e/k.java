...
*/
    ...
    L_0x0057:
        ...
        goto L_0x002f;
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.jiguang.e.k.<clinit>():void");
    }

    public static String a(Context context, String str) {
        try {
            Class loadClass = context.getClassLoader().loadClass(z[0]);
            return (String) loadClass.getMethod(z[1], new Class[]{String.class}).invoke(loadClass, new Object[]{new String(str)});
