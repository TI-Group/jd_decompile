...
public class RecyclerView extends ViewGroup implements NestedScrollingChild, ScrollingView {
    ...
    public final class Recycler {
        ...
        void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                ...
                int i2 = (RecyclerView.this.mAdapter != null && access$800 && RecyclerView.this.mAdapter.onFailedToRecycleView(viewHolder)) ? 1 : 0;
                if (i2 != 0 || viewHolder.isRecyclable()) {
                    if (this.mViewCacheMax <= 0 || viewHolder.hasAnyOfTheFlags(14)) {
                        ...
                        if (RecyclerView.ALLOW_PREFETCHING && i2 > 0 && !RecyclerView.this.mViewPrefetcher.lastPrefetchIncludedPosition(viewHolder.mPosition)) {
                            int i3 = i2 - 1;
                            while (i3 >= 0) {
                                if (!RecyclerView.this.mViewPrefetcher.lastPrefetchIncludedPosition(((ViewHolder) this.mCachedViews.get(i3)).mPosition)) {
                                    break;
                                }
                                i3--;
                            }
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    if (!(smoothScroller == null || smoothScroller.isPendingInitialRun() || !smoothScroller.isRunning())) {
                        ...
                        if (!scrollerCompat.isFinished() || obj2 == null) {
                            ...
                            postOnAnimation();
                            if (RecyclerView.ALLOW_PREFETCHING) {
                                RecyclerView.this.mViewPrefetcher.postFromTraversal(i3, i4);
                            }
                        }
                    }
                }
    ...
    class ViewPrefetcher implements Runnable {
        ...
        public void run() {
            try {
                ...
                toNanos += RecyclerView.sFrameIntervalNanos;
                if (nanoTime - this.mPostTimeNanos > RecyclerView.sFrameIntervalNanos || toNanos - nanoTime < RecyclerView.MIN_PREFETCH_TIME_NANOS) {
                    TraceCompat.endSection();
                    return;
                }
    ...
    private String getFullClassName(Context context, String str) {
        if (str.charAt(0) == ClassUtils.PACKAGE_SEPARATOR_CHAR) {
            return context.getPackageName() + str;
        }
        return !str.contains(".") ? RecyclerView.class.getPackage().getName() + ClassUtils.PACKAGE_SEPARATOR_CHAR + str : str;
    }
                    ...
                    if (actionMasked >= 0) {
                        ...
                        if (this.mScrollState == 1) {
                            ...
                            if (ALLOW_PREFETCHING) {
                                this.mViewPrefetcher.postFromTraversal(i, actionMasked);
                                break;
                            }
                        }
                    }
