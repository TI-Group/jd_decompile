...
public class Toolbar extends ViewGroup {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        currentContentInsetStart = ViewCompat.resolveSizeAndState(Math.max(currentContentInsetStart + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i, -16777216 & i5);
