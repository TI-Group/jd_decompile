        ...
        if (viewHolder != this.mSelected || i != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (viewHolder2.itemView.getParent() != null) {
                    ...
                    RecoverAnimation anonymousClass3 = new RecoverAnimation(viewHolder2, i5, i2, f2, f3, f, signum) {
                        public void onAnimationEnd(ValueAnimatorCompat valueAnimatorCompat) {
                    ...
                    anonymousClass3.setDuration(this.mCallback.getAnimationDuration(this.mRecyclerView, i5, f - f2, signum - f3));
