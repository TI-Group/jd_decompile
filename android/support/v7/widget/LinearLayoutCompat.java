...
public class LinearLayoutCompat extends ViewGroup {
    ...
    void measureHorizontal(int i, int i2) {
            ...
            while (i10 < virtualChildCount) {
                ...
                if (virtualChildAt3 == null) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        i9 = ViewUtils.combineMeasuredStates(i15, ViewCompat.getMeasuredState(virtualChildAt3) & -16777216);
                        f5 = f3;
                    } else {
                        i4 = i14;
                        i9 = i15;
        ...
        setMeasuredDimension((-16777216 & i7) | resolveSizeAndState, ViewCompat.resolveSizeAndState(Math.max(i3 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), i2, i7 << 16));
        if (obj3 != null) {
