...
public final class LinkifyCompat {
    ...
    public static final boolean addLinks(@NonNull Spannable spannable, int i) {
        ...
        if ((i & 1) != 0) {
            ...
            gatherLinks(arrayList, spannable2, PatternsCompat.AUTOLINK_WEB_URL, new String[]{"http://", CommonUtil.URL_HEADER, "rtsp://"}, Linkify.sUrlMatchFilter, null);
        }
        if ((i & 2) != 0) {
            ...
            try {
                ...
                if (findAddress != null) {
                    ...
                    if (indexOf >= 0) {
                        ...
                        i += length;
                        try {
                            linkSpec.url = WebView.SCHEME_GEO + URLEncoder.encode(findAddress, HTTP.UTF_8);
                            arrayList.add(linkSpec);
