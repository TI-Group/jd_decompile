        ...
        if (sharedElementTransition != null) {
            ...
            if (map.isEmpty()) {
                ...
                if (mergeTransitions != null) {
                    FragmentTransitionCompat21.addTransitionTargets(enterTransition, obj, captureExitingViews, view, anonymousClass1, transitionState.nonExistentView, transitionState.enteringEpicenterView, transitionState.nameOverrides, arrayList2, arrayList, map, arrayMap, arrayList3);
        ...
        if (obj != null) {
            ...
            view.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
                public boolean onPreDraw() {
                    ...
                    arrayList2.clear();
                    ArrayMap mapSharedElementsIn = BackStackRecord.this.mapSharedElementsIn(transitionState2, z2, fragment3);
