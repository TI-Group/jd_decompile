    ...
    private static class Ring {
        ...
        private void drawTriangle(Canvas canvas, float f, float f2, Rect rect) {
            if (this.mShowArrow) {
                ...
                float cos = (float) ((this.mRingCenterRadius * Math.cos(JDMaInterface.PV_UPPERLIMIT)) + ((double) rect.exactCenterX()));
                float sin = (float) ((this.mRingCenterRadius * Math.sin(JDMaInterface.PV_UPPERLIMIT)) + ((double) rect.exactCenterY()));
        ...
        public void setInsets(int i, int i2) {
            ...
            if (this.mRingCenterRadius <= JDMaInterface.PV_UPPERLIMIT || min < 0.0f) {
