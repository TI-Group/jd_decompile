...
public final class ax {
    ...
    private static class a implements Comparator {
        ...
        public int compare(Object obj, Object obj2) {
            ...
            if (obj instanceof List) {
                return ax.a((List) obj, (List) obj2);
            }
            if (obj instanceof Set) {
                return ax.a((Set) obj, (Set) obj2);
            }
            if (obj instanceof Map) {
                return ax.a((Map) obj, (Map) obj2);
            }
            if (obj instanceof byte[]) {
                return ax.a((byte[]) obj, (byte[]) obj2);
            }
            return ax.a((Comparable) obj, (Comparable) obj2);
        }
    }
    ...
    public static String a(byte b) {
        return Integer.toHexString((b | 256) & ErrorCode.INFO_CODE_FILEREADER_OPENFILEREADER_MINIQBFAILED).toUpperCase().substring(1);
    }
