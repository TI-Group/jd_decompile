...
public class ah implements av<ah, e>, Serializable, Cloneable {
    ...
    private static final bu d = new bu("Resolution");
    private static final bl e = new bl("height", (byte) 8, (short) 1);
    private static final bl f = new bl("width", (byte) 8, (short) 2);
    ...
    /* compiled from: TbsSdkJava */
    private static class a extends by<ah> {
        private a() {
        }
        ...
        public void a(bo boVar, ah ahVar) throws az {
            boVar.f();
            while (true) {
                bl h = boVar.h();
                if (h.b == (byte) 0) {
        ...
        public void b(bo boVar, ah ahVar) throws az {
            ahVar.j();
            boVar.a(ah.d);
            boVar.a(ah.e);
            boVar.a(ahVar.a);
    ...
    /* compiled from: TbsSdkJava */
    private static class c extends bz<ah> {
        private c() {
        }
    ...
    static {
        ...
        enumMap.put(e.HEIGHT, new be("height", (byte) 1, new bf((byte) 8)));
        enumMap.put(e.WIDTH, new be("width", (byte) 1, new bf((byte) 8)));
